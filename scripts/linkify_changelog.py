...
# " [\#number](https://github.com/airchains-network/wasmbft/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://github.com/airchains-network/wasmbft/issues/\1)", line.rstrip())
    print(line)
