...
[data_structures]: https://github.com/airchains-network/wasmbft/blob/v0.38.x/spec/core/data_structures.md
[types]: https://pkg.go.dev/github.com/airchains-network/wasmbft/types
