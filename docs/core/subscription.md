...
[List of events](https://godoc.org/github.com/airchains-network/wasmbft/types#pkg-constants)
...
section](https://github.com/airchains-network/wasmbft/blob/v0.38.x/spec/abci/abci++_methods.md#endblock) in
the ABCI spec).
