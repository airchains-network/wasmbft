...
```sh
git clone https://github.com/airchains-network/wasmbft.git
cd cometbft
make install_abci
```
...
[here](https://github.com/airchains-network/wasmbft/blob/v0.38.x/abci/cmd/abci-cli/abci-cli.go)
...
Golang](https://github.com/airchains-network/wasmbft/tree/v0.38.x/abci/server). See the
