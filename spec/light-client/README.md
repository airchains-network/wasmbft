...
[Go](https://github.com/airchains-network/wasmbft/tree/v0.38.x/light).
...
[LCV-DIST-SAFE.1](https://github.com/airchains-network/wasmbft/blob/v0.38.x/spec/light-client/verification/verification_001_published.md#lcv-dist-safe1) and
